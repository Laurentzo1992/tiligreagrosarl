...
class WonderPlugin_Slider_View {
	...
	function add_metaboxes() {
		add_meta_box('overview_features', __('Wonder Slider Features', 'wonderplugin_slider'), array($this, 'show_features'), 'wonderplugin_slider_overview', 'features', '');
	...
	function print_register() {
		...
		function validateLicenseForm() {
			...
			if (jQuery.trim(jQuery("#wonderplugin-slider-key").val()).length <= 0)
			{
	...
	function import_export() {
		...
		<h2><?php _e( 'Tools', 'wonderplugin_slider' ); ?></h2>
		...
		<ul class="wonderplugin-tab-buttons-horizontal" id="wp-tools-toolbar" data-panelsid="wonderplugin-popup-display-panels">
			...
			<li class="wonderplugin-tab-button-horizontal"><span class="dashicons dashicons-desktop" style="margin-right:8px;"></span><?php _e( 'PHP Info', 'wonderplugin_slider' ); ?></li>
		</ul>
